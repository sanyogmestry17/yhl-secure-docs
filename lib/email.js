...
export async function sendLoginAlert({ email, ip, location, userAgent, timestamp }) {
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:540px;margin:0 auto;">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:14px;">
          ...
          <tr><td style="padding:10px 14px;font-weight:600;">Location</td><td style="padding:10px 14px;">${location || 'Unknown'}</td></tr>
          <tr style="background:#f5f5f5;"><td style="padding:10px 14px;font-weight:600;">Device</td><td style="padding:10px 14px;">${browser}</td></tr>
          <tr><td style="padding:10px 14px;font-weight:600;">Raw UA</td><td style="padding:10px 14px;font-size:11px;color:#888;">${userAgent}</td></tr>
        </table>
      </div>
    `,
  });
